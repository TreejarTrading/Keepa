...
wsu.cell(row=rr+4, column=1,
    value="Оранжевые строки — ниши, подтверждённые рыночными данными (веб), но US-объём в них ОЦЕНОЧНЫЙ. "
          "Прогони title-поиск в Keepa (напр. «posture corrector») и впиши реальные продажи/цену поставщика.").font = SMALL
wsu.freeze_panes = "A5"
