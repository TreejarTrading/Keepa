...
_COLUMNS: list[tuple[str, str]] = [
    ...
    ("Est sales/mo", "metrics.velocity.estimated_monthly_sales"),
    ("Velocity trend", "metrics.velocity.trend"),
    ("Days inv.", "metrics.inventory.days_of_inventory"),
    ("Reorder qty", "metrics.inventory.recommended_order_qty"),
    ("Stockout risk", "metrics.inventory.stockout_risk"),
    ("Opportunity", "opportunity.score"),
    ("Opp. label", "opportunity.label"),
